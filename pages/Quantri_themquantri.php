                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <table class="table-form-edit" align="center" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                <td height="50px">Chức vụ</td>
                                <td><input type="text" value="Quản lý" size="40"></td>
                            </tr>
                            <tr>
                                <td align="center" height="50px" ></td>
                                <td><a href="#"><input type="submit" value="Thêm" name="submit"></a>
                            </tr>
                        </table>
                    </form>
                    </div>
