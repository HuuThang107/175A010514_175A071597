...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin-left: 220px>
            <div class="col-md-12">
                <center><h3 style="margin-top: 70px; margin-left: 100px">Phân công giảng dạy</h3></center>
                <form method="POST" id="insert_gv_mon" style="width: 500px; margin-left: 320px">
                    <label style="margin-top: 20px">Chọn môn học</label>
